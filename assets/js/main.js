...
sr.reveal('.home-name, .about-container .section-title-1, .about-info, .box-info', {origin:'left'})

sr.reveal('.home-info, .about-profile, .box-form, .contact-social', {origin:'right'})
